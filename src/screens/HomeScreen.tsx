      ...
      <View style={homeStyle.rootContainer}>
        <ScrollView style={homeStyle.container} contentContainerStyle={homeStyle.contentContainer}>
          <View style={homeStyle.getStartedContainer}>
            ...
            <Text style={homeStyle.getStartedText}>Change this text and your app will automatically reload.</Text>
            <Button title='change screen' onPress={() => this.props.navigation.navigate('Guide')} />
          </View>
        </ScrollView>
